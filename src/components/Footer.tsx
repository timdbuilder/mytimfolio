    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold text-white mb-3">Timothy Ezeani</h3>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-500">
          <p>© {currentYear} Timothy Chinedu Ezeani. Built with Next.js & Tailwind CSS.</p>
          <p className="mt-2 text-sm">Designed & Developed with ☕ and 💜</p>
        </div>
      </div>
    </footer>
  );
